      ...
      <div class="navbar bg-red-900 text-white">
        <div class="navbar-start">
          <div class="dropdown">
            ...
            <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-white text-gray-900 rounded-box w-52">
              <li><a>Item 1</a></li>
              <li tabindex="0">
      ...
      <RouterLink to="/" class="btn btn-ghost normal-case text-xl">
        ...
        <div class="navbar-end">
          <div class="dropdown dropdown-end">
            ...
            <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-white bg-gray-900 rounded-box shadow-xl w-52">
              <li>
                <a class="justify-between">
                  Perfil
