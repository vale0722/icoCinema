<template>
  <div class="indicator">
    <span class="indicator-item indicator-start badge bg-red-600 !z-40">Cartelera</span>
    <div class="group overflow-hidden relative shadow-lg max-w-xs h-72 w-56">
      <a href="#" class="absolute z-10 top-0 bottom-0 left-0 right-0">
        ...
        <div class="absolute  bg-gradient-to-br duration-700 from-red-800 to-black-800 text-white block left-0 right-0 top-full text-base h-1/2 w-full opacity-50
