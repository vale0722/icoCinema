<template>
  <section class="min-h-screen flex items-stretch text-white">
    <div
      class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center login"
    >
      <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
      <div class="w-full px-24 z-10">
        <h1 class="text-5xl font-bold text-left tracking-wide">IcoCinema</h1>
        <p class="text-3xl my-4">
          Ven, diviertete y disfruta de tus peliculas favoritas en el mejor
          lugar!
        </p>
      </div>
    </div>
    ...
    >
      <div
        class="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center login"
      >
        <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
      </div>
